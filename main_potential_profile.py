...
atom_limit = 300
radius_increment = 6  # 반지름 증가량을 수정
...
for i in range(0, len(radiuses), radius_increment):
    radius = radiuses[i]
...
plt.plot(radiuses[::radius_increment], potential_barrier, marker='o')  # 반지름을 7개씩 뽑기 위해 슬라이싱
plt.xlabel('Radius')
