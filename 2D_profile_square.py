...
atom_number = np.linspace(1, 65, 65, dtype=int)  # 원자 개수를 1부터 30까지 변화시킬 예정입니다.
...
for num_atoms in atom_number:
    ...
    tip_base = [(x, y) for x in np.arange(0, tip_lattice * num_atoms, tip_lattice) for y in np.arange(0,tip_lattice * num_atoms, tip_lattice)]  # tip_base 초기화
